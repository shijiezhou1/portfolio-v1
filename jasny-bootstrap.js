...
+(function($) {
    ...
    OffCanvas.prototype.calcPlacement = function() {
        ...
        this.placement =
            horizontal >= vertical ? ab("left", "right") : ab("top", "bottom");
    ...
    OffCanvas.prototype.show = function() {
        ...
        elements.addClass("canvas-sliding").each(function() {
            ...
            if (
                ($(this).css(placement) === "auto" ||
                    $(this).css(placement) === "0px") &&
                ($(this).css(opposite) === "auto" ||
                    $(this).css(opposite) === "0px")
            ) {
    ...
    OffCanvas.prototype.hide = function(fast) {
        ...
        var complete = function() {
            ...
            elements
                ...
                .each(function() {
                    $(this)
                        .attr("style", $(this).data("offcanvas-style"))
    ...
    OffCanvas.prototype.recalc = function() {
        if (
            this.$calcClone.css("display") === "none" ||
            (this.state !== "slid" && this.state !== "slide-in")
        )
            return;
...
+(function($) {
    ...
    $(document).on("click.bs.rowlink.data-api", '[data-link="row"]', function(
        e
    ) {
        ...
        this.$element.data(
            ...
            $.proxy(function() {
                return $.map(this.buffer, function(c, i) {
                    return this.tests[i] && c != this.options.placeholder
                        ? c
                        : null;
                }).join("");
            }, this)
